        ...
        '<a id="settings" href="#changeSkin" data-toggle="modal"><i class="fa fa-gear" style="animation: spin 10s infinite cubic-bezier(0.68, -0.55, 0.27, 1.55);"></i> Changer le fond</a>' +   
			...
			'<div class="modal-dialog modal-lg">' +
				...
				'<div class="modal-body">' +
					...
					/*
					    '<a data-skin="skin-blur-suite7"    onclick="FnNavmark(\'skin-blur-suite7\');" class="col-sm-2 col-xs-4" href=""><img src="img/skin-blur-suite7.jpg" alt=""></a>' +	
					    '<a data-skin="skin-blur-suite8"    onclick="FnNavmark(\'skin-blur-suite8\');" class="col-sm-2 col-xs-4" href=""><img src="img/skin-blur-suite8.jpg" alt=""></a>' +	
					    '<a data-skin="skin-blur-suite9"    onclick="FnNavmark(\'skin-blur-suite9\');" class="col-sm-2 col-xs-4" href=""><img src="img/skin-blur-suite9.jpg" alt=""></a>' +	
					    '<a data-skin="skin-blur-suite10"   onclick="FnNavmark(\'skin-blur-suite10\');" class="col-sm-2 col-xs-4" href=""><img src="img/skin-blur-suite10.jpg" alt=""></a>' +	
					    '<a data-skin="sskin-blur-suite11"  onclick="FnNavmark(\'skin-blur-suite11\');" class="col-sm-2 col-xs-4" href=""><img src="img/skin-blur-suite11.jpg" alt=""></a>' +	
					    '<a data-skin="skin-blur-suite12"   onclick="FnNavmark(\'skin-blur-suite12\');" class="col-sm-2 col-xs-4" href=""><img src="img/skin-blur-suite12.jpg" alt=""></a>' +
					*/
				    '</div>' +
				'</div>' +
			    '</div>' +
...
//                    right: 'month,basicWeek,basicDay'
	...
	//	FeedUrl: 'http://rss.cnn.com/rss/edition.rss',
		FeedUrl: 'https://genius2martigues.ingenie.fr/plugins/rss.php?org=155&id=1&langue=FR',	
		MaxCount: 5,
		ShowDesc: false,
		ShowPubDate: true,
